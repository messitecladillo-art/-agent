...
```powershell
python -X utf8 skills/math-modeling-mathematical-writing/scripts/audit_latex_math.py paper/b_problem_solution.tex --release --json
python -X utf8 skills/math-modeling-mathematical-writing/scripts/audit_paper_contract.py paper/b_problem_contract.json --strict --json
```
