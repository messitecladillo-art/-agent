...
- 资料深挖五路回灌：补充 `skills/08-美赛专项.md`、`notes/算法模板盘点.md`，并升级 Skill 01–06 与两条 workflow（含逐年评阅证据、2010B 评分细则、格式硬规范和常见失分点）。
...
本地 T-14/T-15 记录的是议事厅前端与群聊信息流，和上述远端资料任务并列存在；后续新任务从 T-16 起编号。
